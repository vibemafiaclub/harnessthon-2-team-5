/* figma_audit — 생성물. 손으로 고치지 않는다. 규칙 21개(내장 4), stage=design, 생성 2026-09-07T07:44:06.737Z */
...
report.page = page.name; report.roots = roots.length; report.generated_at = "2026-09-07T07:44:06.737Z";
report.builtin_rules = ["frame-spec","primary-action-visible","content-not-cut","no-primitive-binding"];
report.frame_spec = {"width":390,"min_height":844,"bars":["Bar/Status|StatusBar|Status Bar","Bar/Tab|TabBar|Tab Bar"],"source":"기본값","tab_screens":null};
