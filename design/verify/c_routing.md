...
| 화면 | 검사 | 분류 | 처리 | 근거 |
|---|---|---|---|---|
| 02_meetingdetail | frame-spec | local | 수정 | 탭바 3개 제거(54:510·54:541·54:572). 진입 경로가 '홈 카드/일정 카드' 인 push 화면이라 탭바가 있으면 안 된다. 재캡처 02_meetingdetail_normal.png·02_meetingdetail_deadline.png·02_meetingdetail_confirmed.png, 커밋 f06ca80 |
| 04_contacts, 05_contactedit, 06_groupcompose | touch-target-min-inferred | local | 수정 | 입력칸 10개 세로 패딩을 spacing/2→spacing/3 바인딩 교체로 높이 40→48. 재캡처 05_contactedit_edit.png 외 9장, 커밋 f06ca80 |
